...
import com.rakesh.simplewidget.R;



@SuppressLint({ "SuspiciousImport", "SuspiciousImport" })
public class UpdateWidgetService extends Service {
	public void onStart(Intent intent, int startId){
		...
		ComponentName thisWidget = new ComponentName(getApplicationContext(), SimpleWidgetAppWidgetProvider.class);
